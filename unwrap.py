#!/usr/bin/env python3
"""
Python translation of the C code unwrap.c
Nimesh Patel
October 2025

Phase unwrapping code for aperture electric field.

Avoids prompts for user inputs, and uses command line arguments instead, 
to allow running the code in a script for pipeline reduction.
